...
В данном документе описывается функциональность системы отслеживания изменений, которая позволяет автоматически синхронизировать связанные ассоциации и распространять изменения по цепочке преобразований.
