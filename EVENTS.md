...
|------|--------------------------|--------------------|
| Events: подписка 1000 обработчиков | 518.99 µs/итер | 1 926,819 опер/сек |
| EventEmitter: подписка 1000 обработчиков | 363.69 µs/итер | 2 749,594 опер/сек |
| Events: подписка 10000 обработчиков | 3.68 ms/итер | 271,739 опер/сек |
| EventEmitter: подписка 10000 обработчиков | 5.37 ms/итер | 186,22 опер/сек |
| Events: эмиссия события со 100 подписчиками | 25.29 µs/итер | 39 541,321 опер/сек |
| EventEmitter: эмиссия события со 100 подписчиками | 5.57 µs/итер | 179 533,214 опер/сек |
| Events: эмиссия события с 1000 подписчиками | 151.44 µs/итер | 6 603,275 опер/сек |
| EventEmitter: эмиссия события с 1000 подписчиками | 55.71 µs/итер | 17 950,099 опер/сек |
| Events: подписка и отписка 1000 обработчиков | 1.26 ms/итер | 793,651 опер/сек |
| EventEmitter: подписка и отписка 1000 обработчиков | 6.37 ms/итер | 156,986 опер/сек |
