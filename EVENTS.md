...
|------|--------------------------|--------------------|
| Events: подписка 1000 обработчиков | 400.22 µs/итер | 2 498,626 опер/сек |
| EventEmitter: подписка 1000 обработчиков | 298.50 µs/итер | 3 350,084 опер/сек |
| Events: подписка 10000 обработчиков | 4.30 ms/итер | 232,558 опер/сек |
| EventEmitter: подписка 10000 обработчиков | 3.60 ms/итер | 277,778 опер/сек |
| Events: эмиссия события со 100 подписчиками | 8.86 µs/итер | 112 866,817 опер/сек |
| EventEmitter: эмиссия события со 100 подписчиками | 3.74 µs/итер | 267 379,679 опер/сек |
| Events: эмиссия события с 1000 подписчиками | 92.88 µs/итер | 10 766,581 опер/сек |
| EventEmitter: эмиссия события с 1000 подписчиками | 24.09 µs/итер | 41 511 опер/сек |
| Events: подписка и отписка 1000 обработчиков | 241.36 µs/итер | 4 143,189 опер/сек |
| EventEmitter: подписка и отписка 1000 обработчиков | 2.68 ms/итер | 373,134 опер/сек |
