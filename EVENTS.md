...
|------|--------------------------|--------------------|
| Events: подписка 1000 обработчиков | 237.31 µs/итер | 4 213,897 опер/сек |
| EventEmitter: подписка 1000 обработчиков | 196.05 µs/итер | 5 100,74 опер/сек |
| Events: подписка 10000 обработчиков | 3.02 ms/итер | 331,126 опер/сек |
| EventEmitter: подписка 10000 обработчиков | 3.19 ms/итер | 313,48 опер/сек |
| Events: эмиссия события со 100 подписчиками | 18.98 µs/итер | 52 687,039 опер/сек |
| EventEmitter: эмиссия события со 100 подписчиками | 4.26 µs/итер | 234 741,784 опер/сек |
| Events: эмиссия события с 1000 подписчиками | 111.65 µs/итер | 8 956,561 опер/сек |
| EventEmitter: эмиссия события с 1000 подписчиками | 29.39 µs/итер | 34 025,179 опер/сек |
| Events: подписка и отписка 1000 обработчиков | 220.22 µs/итер | 4 540,914 опер/сек |
| EventEmitter: подписка и отписка 1000 обработчиков | 2.27 ms/итер | 440,529 опер/сек |
