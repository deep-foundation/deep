...
|------|--------------------------|--------------------|
| Events: подписка 1000 обработчиков | 265.58 µs/итер | 3 765,344 опер/сек |
| EventEmitter: подписка 1000 обработчиков | 183.93 µs/итер | 5 436,851 опер/сек |
| Events: подписка 10000 обработчиков | 2.64 ms/итер | 378,788 опер/сек |
| EventEmitter: подписка 10000 обработчиков | 1.90 ms/итер | 526,316 опер/сек |
| Events: эмиссия события со 100 подписчиками | 4.05 µs/итер | 246 913,58 опер/сек |
| EventEmitter: эмиссия события со 100 подписчиками | 1.21 µs/итер | 826 446,281 опер/сек |
| Events: эмиссия события с 1000 подписчиками | 34.24 µs/итер | 29 205,607 опер/сек |
| EventEmitter: эмиссия события с 1000 подписчиками | 11.67 µs/итер | 85 689,803 опер/сек |
| Events: подписка и отписка 1000 обработчиков | 142.95 µs/итер | 6 995,453 опер/сек |
| EventEmitter: подписка и отписка 1000 обработчиков | 1.63 ms/итер | 613,497 опер/сек |
...
```javascript
import { Events } from 'deep7/events.js';
