...
Сравнение производительности класса `Events` с нативным `EventEmitter` из Node.js.
...
|------|--------------------------|--------------------|
| Events: подписка 1000 обработчиков | 249.36 µs/итер | 4 010,266 опер/сек |
| EventEmitter: подписка 1000 обработчиков | 215.64 µs/итер | 4 637,359 опер/сек |
| Events: подписка 10000 обработчиков | 2.32 ms/итер | 431,034 опер/сек |
| EventEmitter: подписка 10000 обработчиков | 2.01 ms/итер | 497,512 опер/сек |
| Events: эмиссия события со 100 подписчиками | 4.02 µs/итер | 248 756,219 опер/сек |
| EventEmitter: эмиссия события со 100 подписчиками | 2.13 µs/итер | 469 483,568 опер/сек |
| Events: эмиссия события с 1000 подписчиками | 37.94 µs/итер | 26 357,406 опер/сек |
| EventEmitter: эмиссия события с 1000 подписчиками | 12.98 µs/итер | 77 041,602 опер/сек |
| Events: подписка и отписка 1000 обработчиков | 159.87 µs/итер | 6 255,082 опер/сек |
| EventEmitter: подписка и отписка 1000 обработчиков | 1.82 ms/итер | 549,451 опер/сек |
